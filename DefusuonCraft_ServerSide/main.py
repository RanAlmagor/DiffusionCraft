...
load_dotenv("secrets.env") # ← Load environment variables from .env
...
# Load public keys once at startup
...
def login():
    login_url = (
        ...
        f"&redirect_uri={REDIRECT_URI}&scope=email+openid+profile"
    )
    return RedirectResponse(login_url)

@app.get("/callback")
async def callback(code: str):
    # Encode client credentials as Basic Auth header
